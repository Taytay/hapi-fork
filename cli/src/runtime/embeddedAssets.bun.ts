...
async function selectEmbeddedAssets(): Promise<EmbeddedAsset[]> {
    if (feature('HAPI_TARGET_DARWIN_ARM64')) {
        const [{ default: difftasticArm64Darwin }, { default: ripgrepArm64Darwin }, { default: tunwgArm64Darwin }] =
            await Promise.all([
    ...
    if (feature('HAPI_TARGET_DARWIN_X64')) {
        const [{ default: difftasticX64Darwin }, { default: ripgrepX64Darwin }, { default: tunwgX64Darwin }] =
            await Promise.all([
    ...
    if (feature('HAPI_TARGET_LINUX_ARM64')) {
        const [{ default: difftasticArm64Linux }, { default: ripgrepArm64Linux }, { default: tunwgArm64Linux }] =
            await Promise.all([
    ...
    if (feature('HAPI_TARGET_LINUX_X64')) {
        const [{ default: difftasticX64Linux }, { default: ripgrepX64Linux }, { default: tunwgX64Linux }] =
            await Promise.all([
    ...
    if (feature('HAPI_TARGET_WIN32_X64')) {
        const [{ default: difftasticX64Win32 }, { default: ripgrepX64Win32 }, { default: tunwgX64Win32 }] =
            await Promise.all([
