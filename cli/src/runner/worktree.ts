...
type WorktreeResult = { ok: true; info: WorktreeInfo } | { ok: false; error: string };
...
export async function createWorktree(options: { basePath: string; nameHint?: string }): Promise<WorktreeResult> {
