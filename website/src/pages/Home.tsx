...
export default function Home() {
  ...
  return (
    <Layout>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                <Button
                  size="lg"
                  className="text-lg px-8 py-6 rounded-xl shadow-hard hover:translate-y-1 hover:shadow-none transition-all border-2 border-border bg-primary text-primary-foreground hover:bg-primary/90"
                  asChild
                >
                  <a href="/docs/">
                ...
                <Button
                  variant="outline"
                  size="lg"
                  className="text-lg px-8 py-6 rounded-xl shadow-hard hover:translate-y-1 hover:shadow-none transition-all border-2 border-border bg-background"
                  onClick={() =>
                    window.open("https://github.com/tiann/hapi", "_blank")
                  }
                >
                  {t("hero.githubBtn")}
                </Button>
                  ...
                  <div>
                    ...
                    <p
                      ...
                      dangerouslySetInnerHTML={{
                        __html: t("hero.notification.content"),
                      }}
                    />
                  </div>
                </motion.div>
            ...
            <div className="lg:w-1/2 space-y-8">
              ...
              <div className="space-y-6">
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold mb-2">
                      {t("features.telegram.title")}
                    </h3>
                    <p className="text-muted-foreground">
                      {t("features.telegram.desc")}
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold mb-2">
                      {t("features.yolo.title")}
                    </h3>
                    <p className="text-muted-foreground">
                      {t("features.yolo.desc")}
                    </p>
                  </div>
                </div>
      ...
      <section
        id="how-it-works"
        className="py-20 bg-muted/30 border-y-2 border-border"
      >
        <div className="container">
              ...
              <div className="space-y-2">
                ...
                <div className="bg-slate-950 text-slate-50 p-4 rounded-xl font-mono text-sm flex justify-between items-center border-2 border-slate-800">
                  ...
                  <Button
                    ...
                    onClick={() =>
                      copyToClipboard("npx @twsxtd/hapi hub --relay", "hub")
                    }
                  >
                    {copied === "hub" ? (
              ...
              <div className="space-y-2">
                ...
                <div className="bg-slate-950 text-slate-50 p-4 rounded-xl font-mono text-sm flex justify-between items-center border-2 border-slate-800">
                  ...
                  <Button
                    ...
                    className="text-slate-400 hover:text-white hover:bg-slate-800"
                    onClick={() =>
                      copyToClipboard("npx @twsxtd/hapi", "session")
                    }
                  >
                    {copied === "session" ? (
                      <Check className="h-4 w-4" />
      ...
      <section className="py-20 bg-slate-900 text-white dark:bg-slate-950 border-t-2 border-border">
        <div className="container text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Button
              size="lg"
              className="text-lg px-10 py-8 rounded-xl font-bold shadow-hard hover:translate-y-1 hover:shadow-none transition-all border-2 border-white/20 bg-primary text-primary-foreground hover:bg-primary/90"
              asChild
            >
              <a href="/docs/">
