        ...
        <div className="container">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed">
              ...
              is an excellent project. So why build HAPI?
            </p>
            <p className="mt-4 text-lg">
              The short answer:{" "}
              <strong>Happy is Cloud-First. HAPI is Local-First.</strong>
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-20">
            ...
            <Card className="border-2 border-border shadow-hard bg-card relative overflow-hidden">
              ...
              <CardContent className="space-y-4">
                <p className="text-muted-foreground">
                  Designed for cloud hosting with multiple users. Solves the
                  "untrusted server" problem.
                </p>
                <ul className="space-y-3">
                  <li className="flex items-start gap-2">
                    <Check className="h-5 w-5 text-blue-500 shrink-0 mt-0.5" />
                    <span>
                      <strong>End-to-End Encryption</strong> (E2EE) required
                      because you don't trust the server.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <Check className="h-5 w-5 text-blue-500 shrink-0 mt-0.5" />
                    <span>
                      <strong>Distributed Architecture</strong> (DB + Cache +
                      Storage) for scaling.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <Check className="h-5 w-5 text-blue-500 shrink-0 mt-0.5" />
                    <span>
                      <strong>Complex Deployment</strong> (Docker, multiple
                      services).
                    </span>
                  </li>
                </ul>
            ...
            <Card className="border-2 border-primary shadow-hard-lg bg-card relative overflow-hidden transform md:-translate-y-4">
              ...
              <CardContent className="space-y-4">
                <p className="text-muted-foreground">
                  Designed for self-hosting with a single user. Solves the
                ...
                <ul className="space-y-3">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong>No E2EE Needed</strong> because your data never
                      leaves your machine.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <Check className="h-5 w-5 text-primary shrink-0 mt-0.5" />
                    <span>
                      <strong>Single Embedded Database</strong> (SQLite), no
                      scaling required.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <Check className="h-5 w-5 text-primary shrink-0 mt-0.5" />
                    <span>
                      <strong>One-Command Deployment</strong> (Single binary,
                      zero config).
                    </span>
                  </li>
                </ul>
              ...
              <table className="w-full">
                <thead>
                  <tr className="bg-muted/10">
                    <th className="p-4 text-left font-bold border-b border-border w-1/3">
                      Dimension
                    </th>
                    <th className="p-4 text-left font-bold border-b border-border w-1/3 text-blue-600">
                      Happy
                    </th>
                    <th className="p-4 text-left font-bold border-b border-border w-1/3 text-primary">
                      HAPI
                    </th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-border">
                  <tr>
                    <td className="p-4 font-medium flex items-center gap-2">
                      <Database className="h-4 w-4" /> Data Location
                    </td>
                    <td className="p-4 text-muted-foreground">
                      Cloud Server (Encrypted)
                    </td>
                  ...
                  <tr>
                    <td className="p-4 font-medium flex items-center gap-2">
                      <Lock className="h-4 w-4" /> Trust Model
                    </td>
                    <td className="p-4 text-muted-foreground">
                      Don't trust server
                    </td>
          ...
          <div className="text-center max-w-2xl mx-auto space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="p-6 rounded-xl bg-blue-50 border-2 border-blue-100 dark:bg-blue-950/20 dark:border-blue-900">
                ...
                <p className="text-sm text-muted-foreground">
                  You need multi-user collaboration, team sharing, or don't have
                  a machine to keep running 24/7.
                </p>
              </div>
              ...
              <div className="p-6 rounded-xl bg-primary/10 border-2 border-primary/20">
                ...
                <p className="text-sm text-muted-foreground">
                  You want personal use, complete data sovereignty, and the
            ...
            <Button
              size="lg"
              className="text-lg px-8 h-14 font-bold shadow-hard hover:translate-y-0.5 hover:shadow-none transition-all border-2 border-border mt-8"
              asChild
            >
              <a href="/#installation">
